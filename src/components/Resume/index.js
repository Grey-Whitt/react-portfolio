...
function Resume() {
    ...
    return (
        <Container>
            ...
            <p className='mt-5'>Download my full resume <a rel="noopener noreferrer" target='_blank' href={require(`../../assets/images/Grey Whittenberger's Resume.pdf`)} download>here</a>.</p>
        </Container>
    )
}
